...
<style>
    ...
    .swiper-button-prev::after {
        color: blue;
        font-size: 24px; /* optional: make icons a bit larger */
    }
                                        ...
                                        <div class="aboutsection d-flex">
                                            <div class="icon-box st1  col-lg-6">
                                                <div class="aboutcatagory">
                                                    <div class="img">
                                                       <img src="{{ asset($about->image2) }}" alt="Labaid" class="about-img">
                                                    </div>
                                                      <div class="desc" style="margin-top:15px; margin-left: 5px;"><a href="about.html">Our mission</a></div>
                                                </div>
                                            ...
                                            <div class="icon-box st2  col-lg-6">
                                                <div class="aboutcatagory">
                                                    <div class="img style">
                                                        <img src="{{ asset($about->image3) }}" alt="Labaid" class="about-img">
                                                    </div>
                                                    <div class="desc" style="margin-top:23px;"><a href="about.html">Our Vision</a></div>
                                                </div>
                                                   <p class="txt-transform">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 ">
                            <div class="wrap-service wow fadeInUp">
                                <div class="icon"><img src="{{ asset($serve->image) }}" alt="Labaid" id="serve"></div>
                                <div class="title">
                                    <h4>{{ $serve->name }}
                                    </h4>
                                ...
                                <div class=" swiper-wrapper">
                                      @foreach($certificates as $certificate)
                                        <div class="wrap-team swiper-slide">
                                            <div class="image"><img src="{{ asset($certificate->certificateimage) }}" alt="Labaid"></div>
                                            <div class="title">
                         ...
                         @foreach($categories as $category)
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-4 d-flex">
                                <a href="service-detail.html">
                                    <div class="wrap-service cat-service  flex-column justify-content-between p-3 border rounded w-100 shadow-sm">
                                        <div class="icon mb-3 text-center">
                                            <img src="{{ $category->productcategoryimage }}" alt="Labaid" class="img-fluid" style="max-height: 100px;">
                                        </div>
                                        <div class="title mt-auto text-center">
                                            <a href="service-detail.html" class="h4 d-block mb-2">{{ $category->productcategory }}</a>
            ...
            <section class="choose">
                ...
                <div class="container-TFL">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="col-left col-style wow fadeInUp">
                                <div class="content-choose tfanimated">
                                    ...
                                    <p class="txt-transform">
                                        At the heart of everything we do lies a commitment to excellence, innovation and integrity. By living these six 
                        ...
                        <div class="col-lg-6">
                            <div class="col-right col-style wow zoomIn"><img
                                    src="assets/images/icon/home/latest.jpg" alt="Labaid">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="post-box swiper-slide">
                                <div class="box-img">
                                    <a href="blogdetail.html">
                                        <img src="{{ asset('uploads/' . $blog->image) }}" alt="Labaid" class="img-fluid" />
                                    </a>
                                </div>
