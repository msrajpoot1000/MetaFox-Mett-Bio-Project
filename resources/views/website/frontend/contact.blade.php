...
@section('title', 'Achieve Grade 9 | Contact Us')
            ...
            <div class="row align-items-center">
                        ...
                        <div class="contact-us__widget-list">
                            <div class="contact-us__widget-list-item">
                                ...
                                <div class="text">
                                   ...
                                   <a href="tel:{{ $companyinfos->phone }}">+91 {{ $companyinfos->phone }}</a>
                                </div>
                            </div>
                            <div class="contact-us__widget-list-item mt-40 mb-40">
                                ...
                                <div class="text">
                                    <span>Email</span>
                                    <a href="mailto:{{ $companyinfos->email }}">{{ $companyinfos->email }}</a>
                                </div>
                            </div>
                            <div class="contact-us__widget-list-item">
                                ...
                                <div class="text">
                                    <a href="https://maps.app.goo.gl/uasW7kpa36UwHinm7">{{ $companyinfos->address }}</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-7">
                    <div class="contact-us__form-wrapper mb-30 mb-xs-25">
                        ...
                        <form action="{{ route('contact.store') }}" class="contact-us__form" method="POST"  id="contact-us__form">
                             @csrf
                            <div class="row wow fadeInLeft animated" data-wow-delay=".9s">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="rr-btn mt-30">Send a Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
