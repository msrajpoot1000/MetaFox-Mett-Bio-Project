                ...
                <form action="{{ route('productcategory.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="product_category_description" 
                                  id="product_category_description" class="form-control" 
                                  rows="5" placeholder="Product Category Description...">{{ old('productcategory', $category->product_category_description) }}
                        </textarea>
                    </div>
